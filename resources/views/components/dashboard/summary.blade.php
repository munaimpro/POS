...
<script>
    ...
    async function dashboardContent(){
        showLoader();
        let response = await axios.post('/summary');

        document.getElementById('product').innerHTML = response.data['product'];
        document.getElementById('category').innerHTML = response.data['category'];
        document.getElementById('customer').innerHTML = response.data['customer'];
        document.getElementById('invoice').innerHTML = response.data['invoice'];
        document.getElementById('payable').innerHTML = response.data['payable'];
